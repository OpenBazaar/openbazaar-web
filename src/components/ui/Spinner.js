...
const Spinner = props => {
  ...
  return (
    <svg version="1.1" className="spinner" style={{ width, height }} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     width="20px" height="40px" viewBox="0 0 40 40" enableBackground="new 0 0 20 40" xmlSpace="preserve">
