...
export const LISTING_CARD_CANCEL_OPEN_LISTING = 'LISTING_CARD_CANCEL_OPEN_LISTING';
export const LISTING_CARD_RETRY_OPEN_LISTING = 'LISTING_CARD_RETRY_OPEN_LISTING';
